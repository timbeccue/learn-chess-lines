...
<template>
    <div>
        <b-field label="Data: ">
            <b-radio-button v-model="whatDataToDisplay"
                native-value="examples" >
                examples
            </b-radio-button>
            <b-radio-button v-model="whatDataToDisplay"
                native-value="user">
        ...
        <b-table 
            ...
            <template slot="footer">
                <div class="has-text-right">
                    <b-button 
                        @click="deleteSelectedOpenings"
                        class="is-danger">Delete Selected</b-button>
                </div>
            </template>
        </b-table>
    </div>
    ...
    methods: {
        ...
        deleteSelectedOpenings() {
            ...
            this.selectedRows.forEach(
                o => this.$store.dispatch('openings/removeOpening', o))
        },
    },
    mounted() {
